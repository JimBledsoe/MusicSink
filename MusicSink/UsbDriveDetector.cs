...
namespace UsbDriveEvents
{
    ...
    internal class DetectorForm : Form
    {
        ...
        private UsbDriveDetector mDetector = null;
        ...
        public DetectorForm(UsbDriveDetector detector)
        {
            mDetector = detector;
    ...
    /// </summary>
    class UsbDriveDetector : IDisposable 
    {
        /// <summary>
        ...
        public UsbDriveDetector(Control control)
        {
            Init(control, null);
        }
        ...
        public UsbDriveDetector(Control control, string FileToOpen)
        {
